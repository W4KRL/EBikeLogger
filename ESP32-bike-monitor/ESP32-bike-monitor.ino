...
/*****************************************************
   ...
   2020/08/10 add compiler directive for Arduino OTA
...
//#define ARDUINO_OTA               // UNCOMMENT THIS LINE TO ENABLE ARDUINO OTA
...
#include <WiFi.h>                 // [builtin] for ezTime and OTA
...
#ifdef ARDUINO_OTA
#include <ESPmDNS.h>              // [builtin]
#include <WiFiUdp.h>              // [builtin]
#include <ArduinoOTA.h>           // [builtin]
#endif
